                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8 btn-file">
                                                    <div class="fileupload-new thumbnail">
                                                        ...
                                                        <button type="button" class="btn btn-primary btn-xs btn-add-image"><i class="fa fa-plus" aria-hidden="true"></i> Thêm ảnh</button>
                                                    </div>
                                                    <div>
                                                        {!! Form::text("image_file", null, ['id' => 'image_file', 'data-preview'=>"#preview-file-image-file", 'class' => 'form-control']) !!}
                                                        <div class="p-l-file">
                                                            <a href="#" data-target="image_file" class="iframe-btn browse-image" type="button"><i class="fa fa-paperclip"></i>&nbsp;&nbsp;Chọn hình</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
